  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row overflow-hidden bg-rich-black">
      ...
      >
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-secondary/10 rounded-full blur-[120px] animate-pulse" />
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              { icon: <Zap size={24} />, label: "Ultra Fast" },
              { icon: <Shield size={24} />, label: "End-to-End" },
              { icon: <Sparkles size={24} />, label: "Pure Glass" }
            ].map((item, i) => (
              <motion.div 
                key={i}
      ...
      <motion.div 
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="w-full md:w-1/2 lg:w-[50%] flex items-start md:items-center justify-center p-4 sm:p-8 md:p-12 md:mt-6 lg:p-16 relative z-10 pt-36 pb-16 md:py-12"
      >
        {/* Mobile Ambient Glow */}
