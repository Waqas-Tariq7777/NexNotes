...
import { Lock, ArrowLeft, ShieldCheck, Loader2, CheckCircle2, Eye, EyeOff } from 'lucide-react';
...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL || 'http://localhost:3000'}/api/auth/reset-password/${token}`, { password });
            setSuccess(true);
            setTimeout(() => {
                navigate('/login');
            }, 3000);
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <button 
                                            ...
                                            className="absolute right-4 top-1/2 -translate-y-1/2 text-theme-muted hover:text-white transition-colors"
                                        >
