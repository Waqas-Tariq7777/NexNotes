...
const SignupForm = () => {
  ...
  return (
    <div className="w-full">
      <div className="mb-10">
        <h2 className="text-4xl font-bold text-soft-white mb-3">Sign Up</h2>
        <p className="text-muted-gray text-lg">Create your future in notes.</p>
      </div>
      ...
      <form className="space-y-5" onSubmit={handleSubmit} noValidate>
        ...
        <button 
          type="submit" 
          disabled={loading}
          className="w-full btn-secondary py-4 rounded-2xl text-lg font-bold flex items-center justify-center gap-3 shadow-xl shadow-secondary/20 hover:shadow-secondary/40 transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      <div className="mt-10">
        ...
        >
          ...
          <span className="text-lg font-bold text-white dark:text-soft-white group-hover:text-secondary transition-colors duration-300">Sign up with Google</span>
        </button>
      </div>
    </div>
  );
